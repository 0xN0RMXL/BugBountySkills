...
**Difficulty:** Medium
**Frequency in corpus:** 62 reports used this pattern
...
#### Target
This applies directly to GraphQL processing endpoints, specifically those handling API integrations, file structures, or parameter passing arrays.
...
#### Report Evidence
- [Report #1000567](https://hackerone.com/reports/1000567) — "ReDoS at wiki.cs.money graphQL..." — $0 — CS Money
- [Report #1023669](https://hackerone.com/reports/1023669) — "Staff with no permissions can..." — $0 — Shopify
