...
# Password Reset Flaw — Attack Scenarios
...
**Difficulty:** Medium
**Frequency in corpus:** 55 reports used this pattern
...
#### Target
This applies directly to Password_Reset_Flaw processing endpoints, specifically those handling API integrations, file structures, or parameter passing arrays.
...
#### Report Evidence
- [Report #1092831](https://hackerone.com/reports/1092831) — "Password reset token leak via "Host..." — $0 — Shopify
- [Report #1177287](https://hackerone.com/reports/1177287) — "Password reset token leak on third..." — $0 — UPchieve
