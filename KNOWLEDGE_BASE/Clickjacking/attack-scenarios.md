...
**Difficulty:** Medium
**Frequency in corpus:** 94 reports used this pattern
...
#### Target
This applies directly to Clickjacking processing endpoints, specifically those handling API integrations, file structures, or parameter passing arrays.
...
#### Report Evidence
- [Report #2119892](https://hackerone.com/reports/2119892) — "clickjacing can lead to account takeover" — $200 — pixiv
- [Report #3287060](https://hackerone.com/reports/3287060) — "Double Clickjacking Attack on..." — $0 — WakaTime
