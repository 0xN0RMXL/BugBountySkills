...
**Difficulty:** Medium
**Frequency in corpus:** 17 reports used this pattern
...
#### Target
This applies directly to Cache_Poisoning processing endpoints, specifically those handling API integrations, file structures, or parameter passing arrays.
...
#### Report Evidence
- [Report #1025575](https://hackerone.com/reports/1025575) — "Default..." — $0 — Node.js third-party modules
- [Report #1160407](https://hackerone.com/reports/1160407) — "Cache poisoning Denial of Service..." — $0 — GitLab
