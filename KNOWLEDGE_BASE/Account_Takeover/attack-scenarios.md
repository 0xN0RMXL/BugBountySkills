...
# Account Takeover — Attack Scenarios
...
**Difficulty:** Medium
**Frequency in corpus:** 90 reports used this pattern
**Average bounty for this scenario:** $88
...
#### Target
This applies directly to Account_Takeover processing endpoints, specifically those handling API integrations, file structures, or parameter passing arrays.
...
#### Report Evidence
- [Report #1387366](https://hackerone.com/reports/1387366) — "elections.k8s.io uses weak..." — $125 — Kubernetes
- [Report #3062299](https://hackerone.com/reports/3062299) — "Logout Bypass Vulnerability in Hiro.so" — $50 — Hiro
