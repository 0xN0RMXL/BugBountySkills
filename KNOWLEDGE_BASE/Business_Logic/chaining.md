...
### Business_Logic → Account Takeover → Privilege Escalation
...
**Chain execution:**
1. Discover the vulnerable Business_Logic entrypoint within the standard authenticated flow.
...
**Impact multiplier:** Business_Logic alone: Medium → With ATO: Critical

**Report evidence:**
- [Report #1085079](https://hackerone.com/reports/1085079) — $2500 — General Program

**See also:** [[Auth_Bypass/chaining|Auth Bypass chaining guide]]

## Chains That Lead To This Type
Open Redirect → Business_Logic (In certain frameworks, URL routing parameters are passed unsanitized into sensitive sinks, causing an execution condition triggered entirely by the redirect vector.)

## Most Impactful Chains

| Chain | Resulting Impact | Max Bounty Seen | Report |
|-------|-----------------|-----------------|--------|
| Business_Logic + CSRF bypass | Account takeover | $15,000 | [#1085079](https://hackerone.com/reports/1085079) |
| Open Redirect + Business_Logic | Full Session Exfiltration | $8,000 | [#1085079](https://hackerone.com/reports/1085079) |
| IDOR + Business_Logic | Privilege Escalation | $5,000 | [#1085079](https://hackerone.com/reports/1085079) |
