...
# Business Logic — Complete Hunter's Reference

Business Logic represents a critical security oversight in implementing business logic paradigms. Attackers exploit gaps in input validation, output encoding, or authorization to manipulate application state, accessing data or capabilities designated for other security boundaries.

> [!NOTE] Corpus Statistics
> **Total reports analyzed:** 65
> **Average bounty:** $932
> **Highest bounty on record:** $2,000 — [Report #2914705](https://hackerone.com/reports/2914705) if 65 > 0 else 'N/A'
> **Dominant severity:** Low (44% of reports)
> **Most affected industry:** fintech (16% of reports)
...
|------|----|---------|----------|--------|----------|---------|
| 1 | [Report #2914705](https://hackerone.com/reports/2914705) | Cosmos | High | $2,000 | General | Making transfer v2 channel... |
| 2 | [Report #2917368](https://hackerone.com/reports/2917368) | Cosmos | Low | $2,000 | General | Replacing ICA active channel during... |
| 3 | [Report #2588329](https://hackerone.com/reports/2588329) | inDrive | Critical | $1,000 | General | Change phone number OTP flaw leads... |
| 4 | [Report #3136790](https://hackerone.com/reports/3136790) | Tools for Humanity | Low | $300 | General | Unlock underage blocked... |
| 5 | [Report #2801036](https://hackerone.com/reports/2801036) | Doppler | Critical | $250 | General | Availability Impact from Exploiting... |
| 6 | [Report #3426839](https://hackerone.com/reports/3426839) | AWS VDP | Medium | $43 | General | Unlimited Reuse of Coupon Code... |
| 7 | [Report #2778441](https://hackerone.com/reports/2778441) | Nextcloud | Critical | N/A | General | Exposing debug.log file leads to... |
| 8 | [Report #3403880](https://hackerone.com/reports/3403880) | curl | Critical | N/A | General | Logical Flaw in curl_url_set Leads to... |
| 9 | [Report #3473182](https://hackerone.com/reports/3473182) | curl | Critical | N/A | General | A logic error in detect_proxy caused... |
| 10 | [Report #3483902](https://hackerone.com/reports/3483902) | curl | Critical | N/A | General | PROTOCOL-LEVEL: Persistent UDP... |
