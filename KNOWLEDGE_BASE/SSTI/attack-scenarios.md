...
#### Target
This applies directly to SSTI processing endpoints, specifically those handling API integrations, file structures, or parameter passing arrays.
...
#### Report Evidence
- [Report #1104349](https://hackerone.com/reports/1104349) — "Server Side Template Injection on..." — $0 — Glovo
- [Report #1265344](https://hackerone.com/reports/1265344) — "Self-DoS due to template injection..." — $0 — Acronis
