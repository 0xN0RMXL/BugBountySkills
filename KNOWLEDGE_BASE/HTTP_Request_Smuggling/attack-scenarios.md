...
#### Target
This applies directly to HTTP_Request_Smuggling processing endpoints, specifically those handling API integrations, file structures, or parameter passing arrays.
...
#### Report Evidence
- [Report #3479984](https://hackerone.com/reports/3479984) — "CRLF Injection / Protocol Smuggling in..." — $0 — curl
- [Report #1623672](https://hackerone.com/reports/1623672) — "Host header injection leads to..." — $0 — Enjin
