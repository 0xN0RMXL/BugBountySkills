...
**Difficulty:** Medium
**Frequency in corpus:** 27 reports used this pattern
...
#### Target
This applies directly to LFI processing endpoints, specifically those handling API integrations, file structures, or parameter passing arrays.
...
#### Report Evidence
- [Report #1419213](https://hackerone.com/reports/1419213) — "Grafana LFI on..." — $0 — MariaDB
- [Report #1542734](https://hackerone.com/reports/1542734) — "lfi in..." — $0 — U.S. Dept Of Defense
