...
# Hardcoded Credentials — Attack Scenarios
...
#### Target
This applies directly to Hardcoded_Credentials processing endpoints, specifically those handling API integrations, file structures, or parameter passing arrays.
...
#### Report Evidence
- [Report #1083531](https://hackerone.com/reports/1083531) — "Reset password policy isn't..." — $0 — Enjin
- [Report #1168104](https://hackerone.com/reports/1168104) — "Weak..." — $0 — U.S. General Services Administration
