...
**Difficulty:** Medium
**Frequency in corpus:** 14 reports used this pattern
...
#### Target
This applies directly to XXE processing endpoints, specifically those handling API integrations, file structures, or parameter passing arrays.
...
#### Report Evidence
- [Report #105753](https://hackerone.com/reports/105753) — "[app.informaticaondemand.com] XXE" — $0 — Informatica
- [Report #1156748](https://hackerone.com/reports/1156748) — "XXE in Enterprise Search's App..." — $0 — Elastic
