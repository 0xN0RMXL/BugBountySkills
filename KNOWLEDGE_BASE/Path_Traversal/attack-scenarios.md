...
**Average bounty for this scenario:** $3,000
...
#### Target
This applies directly to Path_Traversal processing endpoints, specifically those handling API integrations, file structures, or parameter passing arrays.
...
#### Report Evidence
- [Report #2995025](https://hackerone.com/reports/2995025) — "Mozilla VPN Clients: RCE via file..." — $6000 — Mozilla
- [Report #3181066](https://hackerone.com/reports/3181066) — "Path Traversal Vulnerability in..." — $1 — Lichess
