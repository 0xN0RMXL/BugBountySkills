...
# Rate Limit Bypass — Theory & Deep Technical Analysis
...
### 1. Context Confusion
Developers often sanitize for one context (e.g., HTML text) but safely render in another (e.g., JavaScript attribute or DOM sink). This failure to understand context switching is the leading root cause. Over 128 reports in this corpus involve some form of context confusion.
