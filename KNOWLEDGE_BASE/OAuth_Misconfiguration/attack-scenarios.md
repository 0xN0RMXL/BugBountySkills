...
# OAuth Misconfiguration — Attack Scenarios
...
#### Target
This applies directly to OAuth_Misconfiguration processing endpoints, specifically those handling API integrations, file structures, or parameter passing arrays.
...
#### Report Evidence
- [Report #1074047](https://hackerone.com/reports/1074047) — "Misconfigured oauth leads to Pre..." — $0 — Bumble
- [Report #110293](https://hackerone.com/reports/110293) — "Insufficient OAuth callback..." — $0 — X / xAI
