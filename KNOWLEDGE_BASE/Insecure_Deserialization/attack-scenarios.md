...
---
# Insecure Deserialization — Attack Scenarios
...
#### Target
This applies directly to Insecure_Deserialization processing endpoints, specifically those handling API integrations, file structures, or parameter passing arrays.
...
#### Report Evidence
- [Report #3079738](https://hackerone.com/reports/3079738) — "Two click Account Takeover" — $0 — Basecamp
- [Report #1167773](https://hackerone.com/reports/1167773) — "Loading YAML in Java client can..." — $0 — Kubernetes
