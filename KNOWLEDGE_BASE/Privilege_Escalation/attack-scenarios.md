...
**Difficulty:** Medium
**Frequency in corpus:** 46 reports used this pattern
...
#### Target
This applies directly to Privilege_Escalation processing endpoints, specifically those handling API integrations, file structures, or parameter passing arrays.
...
#### Report Evidence
- [Report #1021460](https://hackerone.com/reports/1021460) — "Privilege Escalation to..." — $0 — Lark Technologies
- [Report #1036886](https://hackerone.com/reports/1036886) — "Kubelet follows symlinks as root..." — $0 — Kubernetes
